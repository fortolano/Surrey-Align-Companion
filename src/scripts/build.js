...
async function buildWebExport() {
  ...
  return new Promise((resolve, reject) => {
    ...
    exportProcess.on("close", (code) => {
      ...
      const pwaAssets = ["sw.js", "manifest.json", "offline.html", "icon-192.png", "icon-512.png", "apple-touch-icon.png"];
      ...
      console.log(`Copied ${copiedCount} PWA asset(s) into dist/`);
      resolve();
    });

    setTimeout(() => {
      exportProcess.kill();
      console.error("Web export timed out after 120 seconds");
      resolve();
    }, 120000);
  });
}
