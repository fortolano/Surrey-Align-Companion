...
const tlStyles = StyleSheet.create({
  ...
  title: { fontSize: 15, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 16, fontFamily: 'Inter_700Bold' },
...
const vsStyles = StyleSheet.create({
  ...
  formSection: { backgroundColor: Colors.brand.sectionBg, borderRadius: 12, padding: 16, marginTop: 8 },
  formTitle: { fontSize: 15, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 12, fontFamily: 'Inter_700Bold' },
...
const dsStyles = StyleSheet.create({
  ...
  subTitle: { fontSize: 15, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 10, fontFamily: 'Inter_700Bold' },
  fbCard: { backgroundColor: Colors.brand.sectionBg, borderRadius: 10, padding: 12, marginBottom: 8 },
  ...
  commentInput: {
    flex: 1, backgroundColor: Colors.brand.inputBg, borderRadius: 10, borderWidth: 1, borderColor: Colors.brand.inputBorder,
    paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: Colors.brand.dark, fontFamily: 'Inter_400Regular',
    minHeight: 44,
  },
  ...
  decisionSection: { backgroundColor: Colors.brand.sectionBg, borderRadius: 12, padding: 16, marginTop: 8 },
  radioGroup: { marginBottom: 12 },
  radioRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 6 },
  radioText: { fontSize: 14, color: Colors.brand.dark, fontFamily: 'Inter_400Regular' },
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 12, fontFamily: 'Inter_700Bold' },
