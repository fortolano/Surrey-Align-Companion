...
const tlStyles = StyleSheet.create({
  container: { backgroundColor: Colors.brand.white, borderRadius: 14, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: Colors.brand.lightGray },
  title: { fontSize: 14, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 16, fontFamily: 'Inter_700Bold' },
...
const vsStyles = StyleSheet.create({
  ...
  formSection: { backgroundColor: Colors.brand.offWhite, borderRadius: 12, padding: 14, marginTop: 8 },
  formTitle: { fontSize: 14, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 12, fontFamily: 'Inter_700Bold' },
...
const dsStyles = StyleSheet.create({
  ...
  subTitle: { fontSize: 14, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 10, fontFamily: 'Inter_700Bold' },
  fbCard: { backgroundColor: Colors.brand.offWhite, borderRadius: 10, padding: 12, marginBottom: 8 },
  ...
  commentInput: {
    flex: 1, backgroundColor: Colors.brand.offWhite, borderRadius: 10, borderWidth: 1, borderColor: Colors.brand.lightGray,
    paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: Colors.brand.dark, fontFamily: 'Inter_400Regular',
    minHeight: 44,
  },
  ...
  decisionSection: { backgroundColor: Colors.brand.offWhite, borderRadius: 12, padding: 14, marginTop: 8 },
  radioGroup: { marginBottom: 12 },
  radioRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 6 },
  radioText: { fontSize: 14, color: Colors.brand.dark, fontFamily: 'Inter_400Regular' },
...
const styles = StyleSheet.create({
  ...
  headerCard: {
    ...
    padding: 16, borderWidth: 1, borderColor: Colors.brand.lightGray,
  },
  headerTitle: { fontSize: 20, fontWeight: '700' as const, color: Colors.brand.dark, fontFamily: 'Inter_700Bold', marginBottom: 8 },
  ...
  metaChip: { fontSize: 11, color: Colors.brand.darkGray, backgroundColor: Colors.brand.offWhite, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 4, fontFamily: 'Inter_500Medium', overflow: 'hidden' },
  ...
  sectionTitle: { fontSize: 14, fontWeight: '700' as const, color: Colors.brand.dark, marginBottom: 12, fontFamily: 'Inter_700Bold' },
  ...
  tabBar: { flexDirection: 'row', marginHorizontal: 16, marginTop: 14, backgroundColor: Colors.brand.lightGray, borderRadius: 10, padding: 3 },
  tab: { flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: 8 },
  tabActive: { backgroundColor: Colors.brand.white },
  tabText: { fontSize: 12, fontWeight: '500' as const, color: Colors.brand.midGray, fontFamily: 'Inter_500Medium' },
